...
import {
  ...
  Briefcase, ChevronRight, Rocket, CheckCircle2, X
} from 'lucide-react';
import { useNavigate, useParams } from 'react-router-dom';
import { useApp } from '../../../context/AppContext';
import { outboundTemplates } from '../../../data/templates';
...
export const CampaignLaunchScreen: React.FC = () => {
  ...
  const { agents, startCampaign, toast } = useApp();
  ...
  const handleLaunch = () => {
    ...
    if (agent) {
      startCampaign(agent.id, campaignName || agent.name, callTasks);
    }
